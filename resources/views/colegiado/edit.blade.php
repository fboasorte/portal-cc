...
<div class="container">
    <form method="post" action="{{ route('colegiado.update', ['id' => $colegiado->id]) }}" enctype="multipart/form-data" id="form-colegiado">
        @method('PUT')
        @csrf
        <div class="form-group">
            ...
            <div>
                ...
                <input type="date" name="vigencia_fim" id="vigencia_fim" class="form-control" value="{{ date('Y-m-d', strtotime($colegiado->fim)) }}" required>
            </div>
        </div>
        <div class="form-group">
            <h5>Professores </h5>
