                        ...
                        <div class="card-header text-white div-form">
                            ...
                            <div id="pdf">
                                @if ($colegiado_atual && $colegiado_atual->arquivoPortaria)
                                    <a href="{{ asset('storage') }}/{{asset($colegiado_atual->arquivoPortaria->path) }}" download>Download
                        ...
                        <div class="card-body">
                            @if ($colegiado_atual != null)
                                <form method="POST" action="{{ route('colegiado.destroy', $colegiado_atual->id) }}">
                                    ...
                                    <a href="{{ route('colegiado.edit', $colegiado_atual->id) }}"
                                    ...
                                    <tbody>
                                        @if ($colegiado_atual != null && $colegiado_atual->atas)
                                            @foreach ($colegiado_atual->atas as $ata)
                                                <tr>
                                                    <td>
                                                        <a href="" class="btn custom-button modal-trigger"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#showAta_{{ $ata->id }}">{{ date('d/m/Y', strtotime($ata->data)) }}</a>
                                                    </td>
                                                    @include('ata.show')
                                                    <td>
